...
export function lifecycleWorkflowGraph(): GraphDefinition {
  return {
    ...
    edges: withRunBounds([
      ...
      edge("debugging", "verifying", "debug_produced", "verify-retry"),
      edge("debugging", "reviewing", "debug_produced", "review-retry"),
      ...
      edge("building", "failed", "recovery_failed", "recovery-action-failed"),
